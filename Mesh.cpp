...
void MeshTriangle::calFaceNormal(Vertex v1, Vertex v2, Vertex v3) {
...
void MeshTriangle::set_n(int n0, int n1, int n2, int _id) {
	normal_id[0] = n0;
	normal_id[1] = n1;
	normal_id[2] = n2;
	id = _id;
...
void MeshTriangle::set_t(int t0, int t1, int t2, int _id) {
	texture_id[0] = t0;
	texture_id[1] = t1;
	texture_id[2] = t2;
	id = _id;
...
void MeshTriangle::set_nt(int n0, int n1, int n2, int t0, int t1, int t2, int _id) {
	normal_id[0] = n0;
	normal_id[1] = n1;
	normal_id[2] = n2;
	texture_id[0] = t0;
